...
[ -d ~/.Codex/skills/gsd ] || [ -d ~/.Codex/skills/get-shit-done ] && echo "GSD installed"
[ -d ~/.Codex/skills/ui-ux-pro-max ] && echo "ui-ux-pro-max installed"
```
...
I'll do the following:
  ...
  4. Update AGENTS.md with SaaS-specific conventions
...
- `AGENTS.md` (append) — adds SaaS conventions block
- `.gsd/phases/01-*` through `10-*` — phase docs (if GSD installed)

The `AGENTS.md` SaaS block:
...
Generated:
  ...
  AGENTS.md               appended with SaaS conventions
