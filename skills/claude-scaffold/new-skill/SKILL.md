---
name: new-skill
description: Scaffold a new Codex skill — generates SKILL.md with proper frontmatter, optionally wires a route in the main SKILL.md, and prepares it for PR submission to the registry.
version: 1.0.0
author: veekunth217
...
You help a community contributor scaffold a new Codex skill the right way.
...
```bash
# Are we inside the Codex-scaffold-skill repo?
[ -f SKILL.md ] && grep -q "Codex-scaffold-skill\|veekunth217" SKILL.md 2>/dev/null && echo "IN_SCAFFOLD_REPO=true" || echo "IN_SCAFFOLD_REPO=false"
...
```json
{
  ...
  "install": "git clone https://github.com/[github-handle]/[repo-slug-placeholder].git ~/.Codex/skills/[name]",
  "stars": 0,
  "verified": false,
  "added": "[YYYY-MM-DD]"
}
...
To submit your skill to the registry:
  ...
  5. Open a PR against veekunth217/Codex-scaffold-skill

Test it locally first:
  Open Codex in any folder → type /[name]
