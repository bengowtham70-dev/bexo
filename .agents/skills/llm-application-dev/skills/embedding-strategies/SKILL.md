...
| -------------------------- | ---------- | ---------- | ----------------------------------- |
| **voyage-3-large**         | 1024       | 32000      | Codex apps (Anthropic recommended) |
| **voyage-3**               | 1024       | 32000      | Codex apps, cost-effective         |
...
- **Use Voyage AI for Codex apps**: Recommended by Anthropic
